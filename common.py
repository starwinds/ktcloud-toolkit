...
# 2021-05-18: update for watch url
# 2021-07-05: update for autoscaling url
def geturl(**args):
    ...
    elif args['ctype'] == 'watch' and args['m2'] == False:
        return 'https://api.ucloudbiz.olleh.com/watch/v1/client/api?'
    elif args['ctype'] == 'watch' and args['m2'] == True:
        return 'https://api.ucloudbiz.olleh.com/watch/v2/client/api?'
    elif args['ctype'] == 'as' and args['m2'] == False:
        return 'https://api.ucloudbiz.olleh.com/autoscaling/v1/client/api?'
    elif args['ctype'] == 'as' and args['m2'] == True:
        return 'https://api.ucloudbiz.olleh.com/autoscaling/v2/client/api?'
    else:
        return 'error'
